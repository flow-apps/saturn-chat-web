...
const Privacy: React.FC = () => {
  return (
    <>
      <Head>
        <title>Política de privacidade | Saturn Chat</title>
        <meta
          name="description"
          content="Levamos sua privacidade muito a sério. Leia tudo que precisa saber sobre como e porquê usamos seus dados no Saturn Chat aqui."
        />
        <meta
          property="og:title"
          content="Política de privacidade | Saturn Chat"
        />
        <meta
      ...
      <Container>
        <PrivacyContainer>
          <h1>Política de Privacidade do Saturn Chat</h1>
          <h2 id="updated_in">
            Última atualização e validação: 09 de Agosto de 2021
          </h2>

          <p>
            A sua privacidade é importante para nós. É política do site Saturn
            Chat respeitar a sua privacidade em relação a qualquer informação
            sua que possamos coletar no site{" "}
            <a href="https://saturnchat.app/" target="_blank" rel="noreferrer">
              Saturn Chat
            </a>
          ...
          <p>
            ...
            Política de Privacidade pode ser alterado a critério do site Saturn
            Chat, independente de aviso ou notificação. Em caso de alteração, as
          ...
          <ul>
            ...
            <li>
              O serviço Google AdSense (incluindo o Google AdMob) que usamos para veicular publicidade usa
              ...
              é exibido para você.
              <br />
              Para mais informações sobre o Google AdSense (incluindo o Google AdMob), consulte as FAQs
              oficiais sobre privacidade do Google AdSense (incluindo o Google AdMob).
            </li>
          ...
          <p>
            ...
            informação que o site Saturn Chat oferece e com caráter enunciativo,
            mas não limitativo:
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              (softwares) do site Saturn Chat, de seus fornecedores ou
            ...
            <li>
              ...
              (softwares) dos usuários, propagando conteúdos na plataforma
          ...
          <p>
            ...
            Saturn Chat, a qualquer momento, mediante requisição formal,
            informações referentes aos seus dados.
          </p>
          <p>
            Os pedidos serão analisados conforme previsto em legislação vigente
            e, por questões legais, algumas solicitações podem não ser
            atendidas.
          </p>
          ...
          <ul>
            <li>
              Para alterar seus dados pessoais acesse a opção Configurações{" "}
              {">"} Perfil;
            </li>
          ...
          <p>
            O site Saturn Chat empregará esforços para resguardar as informações
            e dados coletados do usuário pelo site. Todavia, considerando que
            não há meio de transmissão e retenção de dados eletrônicos
            plenamente eficaz e seguro, o site Saturn Chat não pode assegurar
            que terceiros não autorizados não logrem êxito no acesso indevido,
            eximindo-se de qualquer responsabilidade por danos e prejuízos
            decorrentes da conduta de terceiros, ataques externos ao site como:
            vírus, invasão ao banco de dados, vícios ou defeitos técnicos, assim
